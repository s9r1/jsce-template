%#!PATH=/opt/texlive/2025/bin/universal-darwin:$PATH; ptex2pdf -l -u -ot '--synctex=1 --shell-escape' -od '-p a4' template-j; skim_reload_pdf template-j
% v1.4 [2026/03/02]
\documentclass{jjsce}
...
%\usepackage{stfloats}\fnbelowfloat % LuaLaTeXの場合
%%
%\usepackage{xcolor}
...
%\enlargeRcolheight0mm % 最終ページの左右の段の高さがかなり異なるときの調整用．詳細はreadme.pdf参照．
